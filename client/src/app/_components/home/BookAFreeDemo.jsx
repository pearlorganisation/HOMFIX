  ...
  const data = [
    {
      ...
      title: "Developers",
      description:
        "Residential, Commercial, Retail & other Space developers can track & control their projects & Budget.",
    },
    {
      ...
      description:
        "Design-build firms and Architect Studios can manage their leads, client proposals, Design delivery workflows and project tracking.",
    },
    {
      img: "https://rdash.io/wp-content/uploads/elementor/thumbs/Contractor-qbxbd84w4j8gcg67gblfa8rvnh7ub679kl3982b1dw.webp",
      title: "Contractors",
      description:
        "General contractors in civil, interiors and specialty contractor of trades can manage their client projects and track progress from field.",
    },
  ];
  ...
  return (
    <>
      <div className="bg-[#F7F8FA]  py-24 space-y-10 border-2">
        ...
        <button class="px-4 py-3 flex mx-auto items-center gap-2 rounded-md font-bold bg-[#0E2337] text-white  transition-all ease-in-out duration-300   hover:bg-[#007bff]">
          Book A Free Demo
        </button>
      </div>
    </>
